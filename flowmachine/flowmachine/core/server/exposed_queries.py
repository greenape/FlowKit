...
class DailyLocationExposed:
    ...
    def __init__(self, *, date, method, aggregation_unit, subscriber_subset):
        self.date = date
        self.method = method
        ...
        self.daily_location = daily_location(date=date_str, level=self.aggregation_unit, method=self.method, subscriber_subset=self.subscriber_subset)

    def __repr__(self):
        return f"<DailyLocation: date='{self.date}', method='{self.method}', aggregation_unit='{self.aggregation_unit}', subscriber_subset='{self.subscriber_subset}'>"
